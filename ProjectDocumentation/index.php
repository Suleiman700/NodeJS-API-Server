                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-4">
                            <ul class="list-unstyled">
                                ...
                                <li><strong>Author:</strong> <a href="#" target="_blank">Suleiman Jaber</a></li>
                            </ul>
                        </div>
                        <div class="col-sm-6 col-lg-4">
                            <ul class="list-unstyled">
                                <li><strong class="font-weight-700">Created:</strong> 24 November, 2022</li>
                                <li><strong>Update:</strong> 24 November, 2022</li>
                            </ul>
                        </div>
                    </div>
                    <p class="alert alert-warning">Currently I've added documentation only for naming conventions</p>
                </section>
...
&lt;!-- Logo End --&gt;
                ...
                <section id="naming_conventions">
                    <?php require_once './pages/naming_conventions.php'; ?>
                </section>
