<div class="idocs-navigation bg-light">
    <ul class="nav flex-column ">
        ...
        <li class="nav-item"><a class="nav-link" href="#naming_conventions">Naming Conventions</a>
            <ul class="nav flex-column">
                <li class="nav-item"><a class="nav-link" href="#naming_variable">Variable</a></li>
                <li class="nav-item"><a class="nav-link" href="#naming_boolean">Boolean</a></li>
                <li class="nav-item"><a class="nav-link" href="#naming_function">Function</a></li>
                <li class="nav-item"><a class="nav-link" href="#naming_class">Class</a></li>
                <li class="nav-item"><a class="nav-link" href="#naming_method">Method</a></li>
                <li class="nav-item"><a class="nav-link" href="#naming_component">Component</a></li>
                <li class="nav-item"><a class="nav-link" href="#naming_constant">Constant</a></li>
                <li class="nav-item"><a class="nav-link" href="#naming_global_variable">Global Variable</a></li>
                <li class="nav-item"><a class="nav-link" href="#naming_object">Object</a></li>
                <li class="nav-item"><a class="nav-link" href="#naming_files">Files</a></li>
            </ul>
        </li>
